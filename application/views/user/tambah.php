...
<div class="jumbotron jumbotron-fluid bg-dark my-2 mx-4">
    ...
    <div class="container text-white">
        ...
        <h1 class="display-4">Selamat datang, <?= $user['nama_instansi']; ?>!</h1>
        <p class="lead">Selamat datang di pusat pelayanan & pengaduan siswa, silahkan adukan permasalahan anda kepada kami.</p>
        <hr class="my-4">
